...
5. **Stop.** The log entry is the last thing you write. Do not re-read it to verify. Do not look for other logs to update. Return control to the orchestrator and wait.
